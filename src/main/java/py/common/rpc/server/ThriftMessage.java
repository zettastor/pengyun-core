...
public class ThriftMessage {
   ...
   * NiftyDispatcher} to create response messages that are similar to their corresponding request
   * messages.
   *
   ...
   * protocols and codecs, a request can indicate that the client understands out-of-order
   * responses.
   *
