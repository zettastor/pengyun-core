...
public class MembershipVersionLowerException extends AbstractNettyException {
  ...
  public static MembershipVersionLowerException fromBuffer(ByteBuf buffer) {
    MembershipVersionLowerException exception = new MembershipVersionLowerException(
        buffer.readLong(),
        buffer.readInt());
  ...
  public String toString() {
    return "MembershipVersionLowerException [super=" + super.toString() + ", volumeId=" + volumeId
        + ", segIndex="
