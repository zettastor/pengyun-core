...
import static py.netty.buffer.AdvancedLeakAwareByteBuf.recordLeakNonRefCountingOperation;
...
public final class AdvancedLeakAwareCompositeByteBuf extends SimpleLeakAwareCompositeByteBuf {
  public AdvancedLeakAwareCompositeByteBuf(CompositeByteBuf wrapped,
  ...
  public CompositeByteBuf addComponent(int indexC, ByteBuf buffer) {
    recordLeakNonRefCountingOperation(leak);
    return super.addComponent(indexC, buffer);
  }
  ...
  public CompositeByteBuf addComponent(boolean increaseWriterIndex, int indexC, ByteBuf buffer) {
    recordLeakNonRefCountingOperation(leak);
    return super.addComponent(increaseWriterIndex, indexC, buffer);
  }
  ...
  public CompositeByteBuf addComponents(int indexC, ByteBuf... buffers) {
    recordLeakNonRefCountingOperation(leak);
    return super.addComponents(indexC, buffers);
  }
  ...
  public CompositeByteBuf removeComponent(int indexC) {
    recordLeakNonRefCountingOperation(leak);
    return super.removeComponent(indexC);
  }

  @Override
  public CompositeByteBuf removeComponents(int indexC, int numComponents) {
    recordLeakNonRefCountingOperation(leak);
    return super.removeComponents(indexC, numComponents);
  }
  ...
  public CompositeByteBuf consolidate(int indexC, int numComponents) {
    recordLeakNonRefCountingOperation(leak);
    return super.consolidate(indexC, numComponents);
  }
