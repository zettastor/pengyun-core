...
final class AdvancedLeakAwareByteBuf extends SimpleLeakAwareByteBuf {
  ...
  private static final Logger logger = LoggerFactory.getLogger(AdvancedLeakAwareByteBuf.class);

  static {
    ACQUIRE_AND_RELEASE_ONLY = true;
  ...
  AdvancedLeakAwareByteBuf(ByteBuf wrapped, ByteBuf trackedByteBuf,
