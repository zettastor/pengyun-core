...
class WrappedCompositeByteBuf extends CompositeByteBuf {
  ...
  @Override
  public CompositeByteBuf addComponent(int indexC, ByteBuf buffer) {
    wrapped.addComponent(indexC, buffer);
    return this;
  }
  ...
  @Override
  public CompositeByteBuf addComponent(boolean increaseWriterIndex, int indexC, ByteBuf buffer) {
    wrapped.addComponent(increaseWriterIndex, indexC, buffer);
    return this;
  }
  ...
  @Override
  public CompositeByteBuf addComponents(int indexC, ByteBuf... buffers) {
    wrapped.addComponents(indexC, buffers);
    return this;
  }
  ...
  @Override
  public CompositeByteBuf addComponents(int indexC, Iterable<ByteBuf> buffers) {
    wrapped.addComponents(indexC, buffers);
    return this;
  }
  ...
  @Override
  public CompositeByteBuf removeComponent(int indexC) {
    wrapped.removeComponent(indexC);
    return this;
  }

  @Override
  public CompositeByteBuf removeComponents(int indexC, int numComponents) {
    wrapped.removeComponents(indexC, numComponents);
    return this;
  }
  ...
  @Override
  public final int toByteIndex(int indexC) {
    return wrapped.toByteIndex(indexC);
  }
  ...
  @Override
  public final ByteBuf component(int indexC) {
    return wrapped.component(indexC);
  }
  ...
  @Override
  public final ByteBuf internalComponent(int indexC) {
    return wrapped.internalComponent(indexC);
  }
  ...
  @Override
  public CompositeByteBuf consolidate(int indexC, int numComponents) {
    wrapped.consolidate(indexC, numComponents);
    return this;
  }
