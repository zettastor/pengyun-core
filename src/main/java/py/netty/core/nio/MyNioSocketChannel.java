...
public class MyNioSocketChannel extends AbstractNioByteChannel implements
    io.netty.channel.socket.SocketChannel {
  private static final InternalLogger logger = InternalLoggerFactory
      .getInstance(MyNioSocketChannel.class);
  ...
  private final class NioSocketChannelConfig extends DefaultSocketChannelConfig {
    ...
    private NioSocketChannelConfig(MyNioSocketChannel channel, Socket javaSocket) {
